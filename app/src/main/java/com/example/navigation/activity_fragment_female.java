...
//                    editText.clearFocus();
//                    recyclerview_adapter = new com.example.findyourhero.RecyclerView_Adapter(Home_Screen.female_name, Home_Screen.female_list_id, Home_Screen.female_list_img_url);
//                    recyclerView.setAdapter(recyclerview_adapter);
//                }
//
//                if (!s.toString().trim().isEmpty()) {
